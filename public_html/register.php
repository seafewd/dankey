...
<div id="registerFormWrapper">
    ...
    <form id="register" action="register.php" name="myForm" method="post" accept-charset="UTF-8">
        ...
        <input type="text" placeholder="<?php echo t("first_name")?>" pattern="[a-zA-ZöäüÜÄÖ-]{1,}" title="<?php echo t("val_firstname")?>" id="firstname" maxlength="50"/><br/>
        <input type="text" placeholder="<?php echo t("last_name")?>" pattern="[a-zA-ZöäüÜÄÖ-]{1,}" name="lastname" title="<?php echo t("val_lastname")?>" id="lastname" maxlength="50"/><br/>
        <input type="text" placeholder="<?php echo t("address")?>" name="address" pattern="[a-zA-Z\söäüÜÄÖ]+[0-9]{1,}" title="<?php echo t("val_address")?>" id="address" maxlength="50"/><br/>
        <input type="text" placeholder="<?php echo t("zip_city")?>" pattern="[0-9]{4}[\s]{1}[a-zA-Z-\söäüÜÄÖ]+" title="<?php echo t("val_city")?>" name="city" id="city" maxlength="50"/><br/>
        <input type="tel" placeholder="<?php echo t("phone")?>" name="phone" id="phone"  title="<?php echo t("val_phone")?>" maxlength="50"/><br/>
        ...
        <input title="<?php echo t("val_date")?>" type="date" name="birthday" id="birthday" maxlength="50"/><br/>
        ...
        <input required type="password" placeholder="<?php echo t("conf_password")?>" name="password2" id="password-conf" maxlength="50" title="<?php echo t("val_password")?>"/><br/>
