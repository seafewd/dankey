...
<div id="registerFormWrapper">
  ...
  <form id="register" action="register.php" name="myForm" method="post" accept-charset="UTF-8">
    ...
    <input type="text" placeholder="Username" pattern="[0-9a-zA-ZöäüÜÄÖ_-]{3,}" title="Please choose a Username with at least 3 charachters. Allowed are nummbers, letters and the special characters - and _"name="username" id="username" maxlength="50"/><br/>
